...
author: "Frida Alendal, Katinca Valvatne"
format:
  html:
    toc: true
    toc-depth: 3
...
knitr::kable(fr1_table_2022,
             digits = 0,
             caption = "GDP per capita (gdp_pc_n3) for topp 6 NUTS3-soner i FR1 (2022)")
...
ggplot(beta_df, aes(x = estimate)) +
  ...
  labs(x = "diff_gdp_per_capita", y = "density") 
...
paste0("Mean: ", format(res_42$mean_estimate, scientific = TRUE, digits = 1))
paste0("Median: ", format(res_42$median_estimate, scientific = TRUE, digits = 1))
